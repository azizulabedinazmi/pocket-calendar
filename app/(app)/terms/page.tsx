...
export default function TermsOfService() {
  ...
  const content = {
    en: {
      title: "Pocket Calendar Terms of Service",
      lastUpdated: "Last updated: April 22, 2025",
      intro: "Welcome to Pocket Calendar! These Terms of Service ('Terms') govern your use of our website, application, and services. By accessing or using Pocket Calendar, you agree to be bound by these Terms. If you do not agree, please do not use our services.",
      sections: [
        {
          heading: "1. Use of Pocket Calendar",
          content: [
            "Pocket Calendar is a scheduling and collaboration tool designed for users of all ages. You may use our services to create, manage, and share calendars, subject to these Terms.",
        ...
        },
        {
          ...
          content: [
            "Pocket Calendar is open-source software licensed under the GNU General Public License v3.0 (GPLv3). You are free to use, modify, and distribute the software in accordance with the terms of the GPLv3.",
        ...
        },
        {
          ...
          content: [
            "You may self-host Pocket Calendar on your own servers. Instructions and source code are available on our GitHub repository.",
        ...
        },
        {
          ...
          content: [
            "Pocket Calendar integrates with third-party services, including Clerk for authentication (via GitHub, Google, or Microsoft) and Vercel Blob for file storage.",
        ...
        },
        {
          ...
          content: [
            "You agree to use Pocket Calendar in compliance with applicable laws and regulations.",
            ...
            "You must not use Pocket Calendar for illegal, harmful, or abusive purposes, including but not limited to distributing malware, engaging in harassment, or violating intellectual property rights."
          ]
        },
        {
          heading: "6. Community Guidelines",
          content: [
            "We encourage a respectful and inclusive community. When collaborating or contributing to Pocket Calendar (e.g., via GitHub), you agree to:",
        ...
        },
        {
          ...
          content: [
            "Content you create in Pocket Calendar (e.g., events, uploaded files) remains your property. By uploading content, you grant us a non-exclusive, worldwide, royalty-free license to store, display, and process it as needed to provide our services.",
            "Pocket Calendar’s software, design, and branding are licensed under GPLv3 or owned by us, except where third-party licenses apply."
          ]
        },
        {
          heading: "8. Limitation of Liability",
          content: [
            "Pocket Calendar is provided 'as is' without warranties of any kind, express or implied, including fitness for a particular purpose.",
            "We are not liable for any damages arising from your use of Pocket Calendar, including data loss, service interruptions, or third-party actions.",
        ...
        },
        {
          ...
          content: [
            "You may stop using Pocket Calendar at any time. You can delete your account via the account settings.",
        ...
        },
        {
          ...
          content: [
            ...
            "Continued use of Pocket Calendar after changes constitutes acceptance of the updated Terms."
          ]
        },
        {
          ...
          content: [
            ...
            "We welcome feedback and contributions to improve Pocket Calendar."
          ]
        }
      ],
      cta: "Want to contribute or learn more about Pocket Calendar?",
      github: "Visit our GitHub",
      home: "Back to Home"
    },
    zh: {
      title: "Pocket Calendar 服务条款",
      lastUpdated: "最后更新：2025年4月22日",
      intro: "欢迎使用 Pocket Calendar！本服务条款（“条款”）规范您对我们的网站、应用程序和服务的访问和使用。使用 Pocket Calendar 即表示您同意受本条款约束。如果您不同意，请勿使用我们的服务。",
      sections: [
        {
          heading: "1. 使用 Pocket Calendar",
          content: [
            "Pocket Calendar 是一个为所有年龄段用户设计的日程安排和协作工具。您可以根据本条款使用我们的服务来创建、管理和共享日历。",
        ...
        },
        {
          ...
          content: [
            "Pocket Calendar 是根据 GNU 通用公共许可证 v3.0 (GPLv3) 许可的开源软件。您可以根据 GPLv3 的条款自由使用、修改和分发软件。",
        ...
        },
        {
          heading: "3. 自托管",
          content: [
            "您可以在自己的服务器上自托管 Pocket Calendar。相关说明和源代码可在我们的 GitHub 仓库中找到。",
        ...
        },
        {
          heading: "4. 第三方服务",
          content: [
            "Pocket Calendar 集成了第三方服务，包括用于身份验证的 Clerk（通过 GitHub、Google 或 Microsoft）和用于文件存储的 Vercel Blob。",
        ...
        },
        {
          heading: "5. 用户责任",
          content: [
            "您同意遵守适用法律法规使用 Pocket Calendar。",
            "您对创建、上传或共享的内容（包括日历事件和通过 Vercel Blob 存储的文件）负责。",
            "您不得将 Pocket Calendar 用于非法、有害或滥用的目的，包括但不限于分发恶意软件、进行骚扰或侵犯知识产权。"
          ]
        },
        {
          heading: "6. 社区准则",
          content: [
            "我们鼓励建立一个尊重和包容的社区。在协作或为 Pocket Calendar 做贡献（例如通过 GitHub）时，您同意：",
            "- 在互动中保持尊重和体贴。",
            "- 不发布冒犯性、歧视性或不适当的内容。",
        ...
        },
        {
          heading: "7. 知识产权",
          content: [
            "您在 Pocket Calendar 中创建的内容（例如事件、上传的文件）仍归您所有。通过上传内容，您授予我们非独占的、全球性的、免版税的许可，以存储、显示和处理内容，以提供我们的服务。",
            "Pocket Calendar 的软件、设计和品牌根据 GPLv3 许可或由我们拥有，除非适用第三方许可。"
          ]
        },
        {
          heading: "8. 责任限制",
          content: [
            "Pocket Calendar 按“现状”提供，不提供任何明示或暗示的保证，包括特定用途的适用性。",
            "我们不对您使用 Pocket Calendar 所产生的任何损害负责，包括数据丢失、服务中断或第三方行为。",
        ...
        },
        {
          heading: "9. 终止",
          content: [
            "您可以随时停止使用 Pocket Calendar，并通过账户设置删除您的账户。",
        ...
        },
        {
          ...
          content: [
            ...
            "在变更后继续使用 Pocket Calendar 即表示接受更新后的条款。"
          ]
        },
        {
          heading: "11. 联系我们",
          content: [
            ...
            "我们欢迎反馈和贡献，以改进 Pocket Calendar。"
          ]
        }
      ],
      cta: "想为 Pocket Calendar 做贡献或了解更多？",
      github: "访问我们的 GitHub",
      home: "返回首页"
    }
  }
